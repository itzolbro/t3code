...
export const PERSISTED_STATE_KEY = "pi-tie:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "pi-tie:renderer-state:v8",
  "pi-tie:renderer-state:v7",
  "pi-tie:renderer-state:v6",
  "pi-tie:renderer-state:v5",
  "pi-tie:renderer-state:v4",
  "pi-tie:renderer-state:v3",
