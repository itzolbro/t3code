...
function getGnomeKeyringRemediationMessage(): string {
  return "Pi Tie could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Pi Tie.";
}

function getKWalletRemediationMessage(): string {
  return "Pi Tie could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Pi Tie.";
}
