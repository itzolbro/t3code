...
// the pool now; the legacy DesktopBackendManager service is gone.
...
// Acquire strict pre-ready setup before the application layer, which can yield
// (e.g. userData resolution) and let Electron emit ready.
